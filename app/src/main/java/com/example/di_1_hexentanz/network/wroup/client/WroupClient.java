package com.example.di_1_hexentanz.network.wroup.client;
...
import com.example.di_1_hexentanz.network.wroup.common.direct.WiFiDirectUtils;
...
import com.example.di_1_hexentanz.network.wroup.common.listeners.DataReceivedListener;
...
import com.example.di_1_hexentanz.network.wroup.common.messages.DisconnectionMessageContent;
import com.example.di_1_hexentanz.network.wroup.common.messages.MessageWrapper;
import com.example.di_1_hexentanz.network.wroup.common.messages.RegisteredDevicesMessageContent;
import com.example.di_1_hexentanz.network.wroup.common.messages.RegistrationMessageContent;
...
public class WroupClient implements PeerConnectedListener, ServiceDisconnectedListener {
     ...
     *  com.abemart.wroup.common.WiFiDirectBroadcastReceiver
     */
                ...
                protected Void doInBackground(Void... params) {
                    ...
                    try {
                        ...
                        while (true) {
                            ...
                            String dataReceived = IOUtils.toString(socket.getInputStream(), Charset.defaultCharset());
