...
public class Gamescreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch(color){
            case BLUE:
                testWitch = new Witch(0, new Player("name", PlayerColor.BLUE,1, felder[0], felder[36]),getApplicationContext(), witchradius);
                break;

            case GREEN:
                testWitch = new Witch(0, new Player("name", PlayerColor.GREEN,2, felder[12], felder[37]),getApplicationContext(), witchradius);
                break;
...
public void startDice() {
    ...
    private void drawBoardGame() {
        ...
        felder[36] = new Feld(36, width-(6*fieldwidth), height-(2*fieldwidth)+(37-31)*fieldwidth, radius, getApplicationContext());
        addContentView(felder[36].getFeldView(), findViewById(R.id.contraintLayout).getLayoutParams());

        felder[37] = new Feld(37, width+(6*fieldwidth), height-(2*fieldwidth)+(37-31)*fieldwidth, radius, getApplicationContext());
        addContentView(felder[37].getFeldView(), findViewById(R.id.contraintLayout).getLayoutParams());
